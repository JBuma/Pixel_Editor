				...
				<div class="vc-chrome-toggle-btn" aria-label="toggleViews" @click="toggleViews">
					<div class="vc-chrome-toggle-icon">
						<svg style="width:24px; height:24px" viewBox="0 0 24 24" @mouseover="showHighlight" @mouseenter="showHighlight" @mouseout="hideHighlight">
							<path fill="white" d="M12,18.17L8.83,15L7.42,16.41L12,21L16.59,16.41L15.17,15M12,5.83L15.17,9L16.58,7.59L12,3L7.41,7.59L8.83,9L12,5.83Z"
							/>
						</svg>
					</div>
...
<style lang="scss">
	...
	.vc-chrome {
		...
		border-radius: 2px; // box-shadow: 0 0 2px rgba(0, 0, 0, .3), 0 4px 8px rgba(0, 0, 0, .3);
		box-sizing: initial;
