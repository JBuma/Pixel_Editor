<template>
	<div class="canvas-wrapper">
		...
		<div ref="canvas-grid" id="canvas-grid" :width="canvasDimensions.x" :height="canvasDimensions.y"  :style="dimensionsToStyle">
...
export default {
  ...
  computed: {
    dimensionsToStyle: function() {
      return `width:${this.canvasDimensions.x}px;height:${
  ...
  methods: {
    ...
    createNewDimensions(newDimensions) {
      ...
      this.canvasDimensions.x =
        biggest && biggest === "x" ? newDimensions.x * scaleX : newDimensions.x;
      this.canvasDimensions.y =
        biggest && biggest === "y" ? newDimensions.y * scaleY : newDimensions.y;

      // Update the gridsize as well
      this.gridSize.x =
        this.canvasDimensions.x / this.$store.state.settings.imageDimensions.x;
      this.gridSize.y =
        this.canvasDimensions.y / this.$store.state.settings.imageDimensions.y;
    }
  },
  mounted() {
    this.gridSize.x =
